...
app.get('/users/:id', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM App_User WHERE User_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/users/:id/team', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Team_Member WHERE User_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/users/:id/tasks', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Task WHERE Assigned_To = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/team', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Team_Member WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/requirements', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Requirement WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/tasks/:id', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Task WHERE Task_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/tasks', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Task WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/dependencies', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Dependency WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/tasks/:id/dependencies', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Dependency WHERE Source_Task = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/issues', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Issue WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/funding-requests', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Funding_Request WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)
...
app.get('/projects/:id/expenses', (req, res) => {
    const { id } = req.params;
    pool.query('SELECT * FROM Expense WHERE Project_ID = $1', [id], (error, results) => {
        if (error) {
            throw error;
        }
        res.status(200).json(results.rows)

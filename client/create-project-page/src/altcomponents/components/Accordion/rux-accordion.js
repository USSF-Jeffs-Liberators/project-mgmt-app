      ...
      <style>
        ...
        *:after {
        ...
        .rux-accordion__label {
          flex-grow: 1;
          padding: var(--accordionLabelPadding, 0.5rem 0.5rem 0.5rem 1rem);
          display: block;
          color: var(--accordionColor, rgb(255, 255, 255));
          white-space: nowrap;
          text-overflow: ellipsis;
          overflow: hidden;
          background: var(--accordionClosedLabelBackground, rgb(32, 50, 70));
          pointer-events: all;
        ...
        .rux-accordion__label:hover {
          background: var(--accordionHoverLabelBackground, rgb(46, 103, 153));
        }
      </style>

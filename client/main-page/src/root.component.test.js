...
describe("Logged Out", () => {
  let wrapper = {};
  beforeEach(() => {
    wrapper = shallow(<Root loggedIn={false} />);
  });
...
describe("Logged In", () => {
  let wrapper = {};
  beforeEach(() => {
    wrapper = shallow(<Root loggedIn={true} />);
  });
...
describe("Developer", () => {
  let wrapper = {};
  beforeEach(() => {
    wrapper = shallow(<Root loggedIn={true} userType={"Developer"} />);
  });
...
describe("Project Manager", () => {
  let wrapper = {};
  beforeEach(() => {
    wrapper = shallow(<Root loggedIn={true} userType={"Project Manager"} />);
  });
...
describe("General Manager", () => {
  let wrapper = {};
  beforeEach(() => {
    wrapper = shallow(<Root loggedIn={true} userType={"General Manager"} />);
  });

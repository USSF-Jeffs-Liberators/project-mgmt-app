...
const TeamRoster = (props) => {
    ...
    const getTeamRoster = async (allUsersOnTeams) => {
      let teamMembers = []
      for (let i = 0; i < allUsersOnTeams.length; i++) {
        if (allUsersOnTeams[i].project_id == projectID) {
          teamMembers.push(allUsersOnTeams[i])
        }
      }
      team = teamMembers;
    };
